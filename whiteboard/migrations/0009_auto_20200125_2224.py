...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='repscheme',
            name='wod',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='whiteboard.WOD', verbose_name='WOD Name'),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rep_scheme', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='whiteboard.RepScheme', verbose_name='Rep Scheme')),
            ],
        ),
    ]
